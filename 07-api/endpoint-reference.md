...
Documentation gap: this section still needs endpoint-by-endpoint pages with examples for every public route. Continue from `documentation/maintenance-plan.md`.
