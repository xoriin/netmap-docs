...
This reference lists important paths in the all-in-one container, the development checkout, and the hosted documentation project. Use it when configuring volumes, backups, troubleshooting, or release builds.
...
| `/app/VERSION_CHANNEL` | Installed channel file |
